            ...
            <div class="card-body">
              <table id="example1" class="table table-sm table-bordered table-striped">
                ...
                <tbody>
                  ...
                  @foreach($favouriteExercises as $ex)
                  <tr>
                    <td>{{ $ex->title }}</td>
                    <td>{{ $ex->duration }}</td>
                    <td>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example2" class="table table-sm table-bordered table-striped">
                ...
                <tbody>
                  @foreach($favouriteWorkouts as $wk)
                  <tr>
                    <td>{{ $wk->title }}</td>
                    <td>{{ $wk->duration }}</td>
                    <td>
            ...
            <div class="card-body">
              <table id="example3" class="table table-sm table-bordered table-striped">
                ...
                <tbody>
                  ...
                  @foreach($favouritePrograms as $pr)
                  <tr>
                    <td>{{ $pr->title }}</td>
                    <td>{{ $pr->duration }}</td>
                    <td>
            ...
            <div class="card-body">
              <table id="example5" class="table table-sm table-bordered table-striped">
                ...
                <tbody>
                  ...
                  @foreach($favouriteStreches as $fs)
                  <tr>
                    <td>{{ $fs->title }}</td>
                    <td>{{ $fs->duration }}</td>
                    <td>
                      @if($fs->image)
                        @if(file_exists('uploads/programs/images/'.$fs->image))
                          <img width="40" src="{{ asset('uploads/programs/images/'.$pr->image) }}" alt="{{ $fs->title }}"/>
                        @else
                          <img width="40" src="{{ asset('uploads/default-placeholder.png') }}" alt="{{ $fs->title }}"/>
                        @endif
                      @else
                        <img width="40" src="{{ asset('uploads/default-placeholder.png') }}" alt="{{ $fs->title }}"/>
                      @endif
